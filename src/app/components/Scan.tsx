...
export default function ScanProduct() {
  ...
  console.log(data, error, "hash");
	...
	// 				const ipfsFetchPromises = data.map((item) =>
	...
	useEffect(() => {
		let result = !address ? true : false;
		setOpenWallet(result);
	}, [address]);

  console.log(address, "hello")
	return (
		<>
    <p>skljhhjshjshjhjshshshshj</p>
			{address ? (
				...
				<ConnectModal isOpen={openWallet} onClose={toggleUserModal} />
			)}
		</>
	);
}
